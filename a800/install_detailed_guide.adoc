...
+
video::edc42447-f721-4cbe-b080-ab0c0123a139[panopto, title="Cable a two-node switchless cluster"]
+
...
. Use the animation or the tabulated steps to complete the cabling between the controllers and the switches:
+
video::49e48140-4c5a-4395-a7d7-ab0c0123a10e[panopto, title="Cabling a switched cluster"]
+
[options="header" cols="10,90"]
|===
| Step| Perform on each controller module
...
video::09dade4f-00bd-4d41-97d7-ab0c0123a0b4[panopto, title="Cabling the controllers to a single drive shelf"]
+
[options="header" cols="10,90"]
|===
| Step| Perform on each controller module
...
video::fe50ac38-9375-4e6b-85af-ab0c0123a0e0[panopto, title="Cabling the controllers to two drive shelves"]
+
[options="header" cols="10,90"]
|===
| Step| Perform on each controller module
...
+
video::d61f983e-f911-4b76-8b3a-ab1b0066909b[panopto, title="Connecting your laptop to the Management switch"]
