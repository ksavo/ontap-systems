 ...
 ** <<Option 1: Connecting to a Fibre Channel host>>
 ** <<Option 2: Connecting to a 10GbE host>>
 ** <<Option 3: Connecting to a single direct-attached NS224 drive shelf>>
 ** <<Option 4: Connecting to two direct-attached NS224 drive shelves>>
