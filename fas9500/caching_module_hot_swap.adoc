---
permalink: fas9500/caching-module-hot-swap.html
sidebar: sidebar
...
NOTE: If you need to or want to cold-swap the FlashCache module, follow the procedures replacing an I/O module.
