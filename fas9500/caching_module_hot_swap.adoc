...
* The caching module must be functioning well enough to be seen by the system.  If the caching module is not functioning since the last booted, you cannot use this procedure and must use the cold-swap procedure.
