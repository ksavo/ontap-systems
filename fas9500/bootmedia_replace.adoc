...
+
image::../media/drw_9500_remove_PCM_source.png["Alternative text",pdfwidth=50%]
+
image::../media/drw_9500_remove_PCM_source.svg["base"]
+
[cols="10,90"]
|===
a|
...
+
image::../media/drw_9500_PCM_open_source.png[Alternative text",pdfwidth=50%]
+
image::../media/drw_9500_PCM_open_source.svg["500 pixels wide",width=500px]
...
image::../media/drw_9500_remove_boot_dev_source.png[Alternative text",widt=500px, pdfwidth=6in]
+
image::../media/drw_9500_remove_boot_dev_source.svg["PDFwidth @50%",width=500px, pdfwidth=6in]
