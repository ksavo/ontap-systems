...
+
image::../media/drw_9500_remove_PCM_source.png["Alternative text",pdfwidth=99%]
+
[cols="10,90"]
|===
a|
...
+
image::../media/drw_9500_PCM_open_source.png[Alternative text",pdfwidth=99%]
...
image::../media/drw_9500_remove_boot_dev_source.png[Alternative text",pdfwidth=99%]
