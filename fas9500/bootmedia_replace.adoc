...
+
image::../media/drw_9500_remove_PCM_source.svg["PDFwidth @50%",pdfwidth=50%]
+
[cols="10,90"]
|===
a|
...
+
image::../media/drw_9500_PCM_open_source.svg["PDFwidth @50%",pdfwidth=50%]
...
image::../media/drw_9500_remove_boot_dev_source.png[Alternative text",pdfwidth=50%]
+
image::../media/drw_9500_remove_boot_dev_source.svg["PDFwidth @50%",pdfwidth=50%]
