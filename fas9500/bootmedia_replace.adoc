...
+
image::../media/drw_a900_remove_PCM.png["Alternative text",pdfwidth=50% Test]
////
image::../media/drw_9500_remove_PCM.png[]
////
+
[cols="10,90"]
|===
...
+
image::../media/drw_a900_PCM_open.png[Alternative text",pdfwidth=50% Test]
+
[cols="10,90"]
|===
a|
...
+
image::../media/drw_a900_remove_boot_dev.png[Alternative text",pdfwidth=50% Test]
+
[cols="10,90"]
|===
a|
