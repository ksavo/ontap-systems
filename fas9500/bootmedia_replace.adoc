...
+
image::../media/drw_9500_remove_PCM_source.png["base"]
+
...
+
image::../media/drw_9500_PCM_open_source.png[Alternative text",width=500px ]
+
...
image::../media/drw_9500_remove_boot_dev_source.png[Alternative text",width=500px, pdfwidth=6in]
+
