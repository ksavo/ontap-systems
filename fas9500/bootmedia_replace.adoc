...
+
image::../media/drw_9500_remove_PCM_source.svg[SVG test graphic]
+
[cols="10,90"]
|===
a|
...
+
image::../media/drw_9500_PCM_open_source.svg[SVG test graphic]
...
+
image::../media/drw_9500_remove_boot_dev_source.svg[SVG test graphic]
