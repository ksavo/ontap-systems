...
image::../media/drw_a900_tnsc_network_cabling.svg[width=400px]
...
image:../media/oie_legend_icon_1_lg.svg[width=400px]
a|
...
image:../media/oie_legend_icon_2_lp.svg[width=400px]
a|
...
image::../media/oie_legend_icon_3_o.svg[width=400px]
a|
...
image::../media/oie_legend_icon_4_dr.png[width=400px]
a|
...
=== Option 1: Cable the controllers to a single NS224 drive shelf in FAS9500
