...
== Step 1: Most configurations

include::../_include/shutdown_most_frus.adoc[]

== Step 2: Controller is in a two-node MetroCluster configuration
...
== Step 4: Add or replace an X9170A core dump module
...
== Step 5: Reboot the controller after FRU replacement
