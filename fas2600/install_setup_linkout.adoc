...
You can use the PDF poster to install and set up your new system. The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2316768[AFF FAS2600 Installation and Setup Instructions^] provides step-by-step instructions with live links to additional content.
