...
sidebar: sidebar
keywords: fas2600, replace, boot, media, controller, direction, module, fru map
summary: 'You must locate the boot media in the controller and follow the directions to replace it.'
---
= Remove the controller module, replace the boot media and transfer the boot image to the boot media - FAS2600
:icons: font
:imagesdir: ../media/
...
image::../media/drw_25xx_cable_management_arm_sm.png[]

image::../media/drw_25xx_cable_management_arm_lg.png[]
...
+
image::../media/drw_2600_boot_media_move_aminated_gif.gif[]

image::../media/drw_2600_boot_media_move_aminated_gif_lg.png[]

image::../media/drw_2600_boot_media_move_aminated_gif_sm.png[]
