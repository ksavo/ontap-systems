...
[.lead]
To replace a mezzanine card, you must remove the impaired card and install the replacement card; to install a mezzanine card, you must remove the face plate and install the new card.

You can use the following video or the tabulated steps to replace a mezzanine card:

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d8e7d4d9-8d28-4be1-809b-ac5b01643676[Replacing a mezzanine card]https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=d8e7d4d9-8d28-4be1-809b-ac5b01643676[Replacing a mezzanine card]
...
Make sure that you label the cables so that you know where they came from.
 ...
 .. Using the #1 magnetic screw driver remove the screws from the face of the controller module and set them aside safely on the magnet.
 .. Using the #1 magnetic screw driver loosen the screw on the impaired mezzanine card.
 .. Gently lift the impaired mezzanine card directly out of the socket and set it aside
 ...
 .. Using the #1 magnetic screw driver insert and tighten the screws on the face of the controller module and on the mezzanine card.
+
...
. You install a new mezzanine card if your system does not have one.
 .. Using the #1 magnetic screw driver remove the screws from the face of the controller module and the faceplate covering the mezzanine card slot, and set them aside safely on the magnet.
