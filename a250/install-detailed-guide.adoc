...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=beec3966-0a01-473c-a5de-ac68017fbf29[Cabling a two node switchless cluster^]
+
...
. Use the animation or the step-by step instructions to complete the cabling between the controllers and to the switches:
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=bf6759dc-4cbf-488e-982e-ac68017fbef8[Cabling a switched cluster^]
+
[options="header" cols="1,2"]
|===
| Step| Perform on each controller
...
+
link:https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=3f92e625-a19c-4d10-9028-ac68017fbf57[Cabling the controllers to a single NS224^]
+
[options="header" cols="1,2"]
|===
| Step| Perform on each controller module
