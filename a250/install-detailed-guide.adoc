...
a|
Cable the cluster interconnect ports to each other with the 25GbE cluster interconnect cable image:../media/oie_cable_sfp_gbe_copper.gif[]:
...
. To complete setting up your system, see <<Step 4: Completing system setup and configuration>>
...
* <<Option 3: Cabling the controllers to a single drive shelf>>
...
3
a|
To complete setting up your system, <<Step 4: Completing system setup and configuration>>.
|===
