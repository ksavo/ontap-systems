...
[.lead]
To replace the NV battery, you must remove the failed battery from the controller module and install the replacement battery into the controller module.

You can use the following video or the tabulated steps to replace the NVMEM battery:

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=89f6d5c3-1a5b-4500-8ba8-ac5b01653050[Replacing the NVMEM battery]https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=89f6d5c3-1a5b-4500-8ba8-ac5b01653050[Replacing the NVMEM battery]
