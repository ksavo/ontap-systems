---
permalink: fas9000/caching_module_and_core_dump_module_replace.html
sidebar: sidebar
keywords:
...
* For instructions about hot swapping the caching module, see link:../fas9000/caching_module_hot_swap.html[Hot-swapping a caching module].
