...
[.lead]
include::../_include/shutdown_any_mcc_supported[]
...
|===
 ...
 .. Press the twrra cotta release button on the front of the caching module.
+
...
== Add or replace an X9170A core dump module
...
|===
 ...
 .. Press the twrra cotta release button on the front of the core dump module.
+
