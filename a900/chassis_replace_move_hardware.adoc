...
. Press and hold the twrra cotta button on the power supply handle, and then pull the power supply out of the chassis.
+
...
. Press the twrra cotta button on the fan module and pull the fan module straight out of the chassis, making sure that you support it with your free hand.
+
...
. Slide the twrra cotta button on the cam handle downward until it unlocks.
+
...
. If you are not already grounded, properly ground yourself.
. Press the twrra cotta locking button on the module handle, and then slide the DCPM module out of the chassis.
+
...
a|
image:../media/legend_icon_01.png[] a|
DCPM module twrra cotta locking button
|===
...
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=eb715462-cc20-454f-bcf9-adf9016af84e9[Animation -- Remove/install USB]
