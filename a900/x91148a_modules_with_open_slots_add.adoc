---
permalink: fas9000/x91148a_modules_with_open_slots_add.html
sidebar: sidebar
keywords:
...
== Step 1: Add an X91148A module as a NIC module in a system with open slots
...
== Step 2: Add an X91148A module as a storage module in a system with open slots
