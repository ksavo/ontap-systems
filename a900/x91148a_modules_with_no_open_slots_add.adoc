---
permalink: fas9000/x91148a_modules_with_no_open_slots_add.html
sidebar: sidebar
keywords:
...
== Step 1: Add an X91148A module as a NIC module in a system with no open slots
...
== Step 2: Adding an X91148A module as a storage module in a system with no open slots
