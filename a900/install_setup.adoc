---
permalink: fas9000/install_setup.html
sidebar: sidebar
...
* link:../fas9000/install_quick_guide.html[Quick steps]
+
A printable PDF of step-by-step instructions with live links to additional content.

* link:../fas9000/install_videos.html[Video steps]
+
Video step-by-step instructions.

* link:../fas9000/install_detailed_guide.html[Detailed steps]
+
