---
permalink: a900/dcpm_nvram10_battery_replace.html
sidebar: sidebar
keywords: AFF A900
...
---
= Replace the de-stage controller power module containing the NVRAM10 Battery - AFF A900
:icons: font
:imagesdir: ../media/
...
== Step 1: Replacing the DCPM module
