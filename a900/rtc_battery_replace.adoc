...
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=1bb4d8d4-5040-471c-9593-adf2000df48d[Animation--Replace RTC battery^]
+
...
[.lead]
After you replace a component within the controller module, you must reinstall the controller module in the system chassis, reset the time and date, if the controller has been left out of the chassis for too long, and then boot it.
