...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=30337552-b10f-4146-9bdb-adf2000df5bd[Move components to replacement controller^]
+
...
image::../media/drw_9000_replace_pcm_dimms.svg[]
+
[cols="1,1"]
|===
a|
...
+
https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=099237f3-d7f2-4749-86e2-adf2000df53c[Install controller]
+
image::../media/drw_a900_remove_PCM.png[]
+
[cols="1,1"]
