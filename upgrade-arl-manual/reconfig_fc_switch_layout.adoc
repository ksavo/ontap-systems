...
. link:send_customer_asup_message_prior_reconfig_switches.html[Send a custom AutoSupport message prior to reconfiguring switches]
...
. link:verify_switchover_healing_switchback.html[Verify switchover, healing, and switchback]
