---
sidebar: sidebar
permalink: upgrade-arl-manual/move_nas_lifs_node1_from_node2_node3_verify_san_lifs_node.html
...
. [[step5]]If you have data ports that are not the same on your platforms, then add the ports to the broadcast domain:
+
