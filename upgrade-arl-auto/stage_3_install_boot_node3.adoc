...
permalink: upgrade-arl-auto/stage_3_install_boot_node3.html
...
[.lead]
include::../_include/ru_stage3.adoc[]
...
.. link:check_config_uta_uta2_ports_node3.html[Check and configure UTA/UTA2 ports on node3]
...
. link:recreate_vlans_ifgrps_broadcast_domains_node3.html[Re-creating VLANs, ifgrps, and broadcast domains on node3]
. link:restore_key-manager_config_node3.html[Restore key-manager configuration on node3]
