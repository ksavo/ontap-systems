...
[.lead]
include::../_include/ru_get_address_key_management_server_encryption.adoc[]
...
include::../_include/ru_manage_authentication_kmip.adoc[]

include::../_include/ru_manage_authentication_okm.adoc[]
