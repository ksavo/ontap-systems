...
include::../_include/ru_install_and_boot_node4_intro_step_5.adoc[]
...
include::../_include/ru_install_and_boot_node4_step_7_22.adoc[]
...
include::../_include/ru_install_and_boot_node4_step_24_28.adoc[]

[start=29]
. [[Step29]] For MetroCluster configuration, V-Series systems and systems with FlexArray Virtualization software connected to storage arrays, go to link:set_fc_or_uta_uta2_config_node4.html#Step15[Check and configure UTA/UTA2 ports on node4, Step 15].
