...
+
Refer to link:other_references.html[Other references] to link to the _ONTAP 9 Network Management Guide_ or the _ONTAP 9 Commands: Manual Page Reference_ and see "Configuring failover settings on a LIF" for more information.
