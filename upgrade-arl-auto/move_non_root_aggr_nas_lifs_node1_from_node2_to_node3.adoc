...
+
If any aggregates fail to relocate or are vetoed, you must manually relocate the aggregates, or override either the vetoes or destination checks, if necessary. See link:relocate_failed_vetoed_aggr.html[Relocate failed or vetoed aggregates] for more information.
