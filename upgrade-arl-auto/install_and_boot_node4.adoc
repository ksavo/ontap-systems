...
. For MetroCluster configuration, V-Series systems and systems with FlexArray Virtualization software connected to storage arrays, go to link:setting_the_fc_or_uta_uta2_configuration_on_node4.html#Step15[Step 15].
