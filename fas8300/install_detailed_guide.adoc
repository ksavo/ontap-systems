...
.Steps
. Use the following animation or graphic to set one or more drive shelf IDs:
+
...
. Use the following animation or graphic to connect your laptop to the Management switch.
+
