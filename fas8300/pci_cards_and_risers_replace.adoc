...
You can use the following animation, drawing, or the written steps to remove the controller module from the chassis.
...
You can use the following animation, drawing, or the written steps to replace a PCIe card.

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=84339f87-321c-400e-985e-aae10182cd24[Replacing a PCIe card]
...
You can use the following animation, drawing, or the written steps to replace the mezzanine card.

https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=4e00f5b1-8ca5-4cd6-9881-aadb01578e52[Replacing the mezzanine card]
