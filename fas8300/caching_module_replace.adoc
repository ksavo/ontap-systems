...
. Although data on the caching module is encrypted, you might want to erase any data from the impaired caching module and verify that the caching module has no data:
 .. Erase the data on the caching module: `system controller flash-cache secure-erase run -node node_name -device-id device_id`
...
=== Shut down a node in a two-node MetroCluster configuration
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=75b6fa91-96b9-4323-b156-aae10007c9a5[Removing the controller module] https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=75b6fa91-96b9-4323-b156-aae10007c9a5[Removing the controller module]
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=d5f75ac5-b4f3-4b49-984b-aad9012f0c8e[Replacing the caching module] https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=d5f75ac5-b4f3-4b49-984b-aad9012f0c8e[Replacing the caching module]
...
https://netapp.hosted.panopto.com/Panopto/Pages/embed.aspx?id=9249fdb8-1522-437d-9280-aae10007c97b[Installing the cotroller module] https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9249fdb8-1522-437d-9280-aae10007c97b[Installing the controller module]
