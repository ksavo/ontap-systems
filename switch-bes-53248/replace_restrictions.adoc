...
See link:replace_install_licenses.md#GUID-AED23E98-3003-46F9-B1C8-128A3F7A470E[Installing licenses for BES-53248 cluster switches] for details of the firmware versions supported for available licenses.
