...
. Verify that the script was downloaded and saved to the file name you gave it: `script list`
+
----
(cs2) # **script list**
...
. Apply the script to the switch. `script apply`
+
----
...
. Verify the ports for an additional license after the RCF is applied: `show port all | exclude Detach`
+
----
...
. Verify on the switch that your changes have been made: `show running-config`
+
----
