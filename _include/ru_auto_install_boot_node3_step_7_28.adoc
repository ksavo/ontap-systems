...
|Go to <<auto_istall3_step23,Step 23>>
...
.. Return to this section and complete the remaining steps, beginning with <<auto_istall3_step23,Step 23>>.
...
. [[auto_istall3_step23]]Add the FC initiator ports of the new node to the switch zones.
+
