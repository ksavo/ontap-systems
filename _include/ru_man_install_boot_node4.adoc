...
a|
.. Go to the section _Set the FC or UTA/UTA2 configuration on node4_ and complete the sections link:set_fc_uta_uta2_config_node4.html#configure-fc-ports-on-node4[ Configure FC ports on node4] and link:set_fc_uta_uta2_config_node4.html#check_and_configure_UTAUTA2_ports_on_node4[Check and configure UTA/UTA2 ports on node4], as appropriate to your system.
