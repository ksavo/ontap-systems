...
. [[step2]]Disable storage failover, as applicable:
+
[cols="35,65"]
|===
...
. [[step6]]Access the advanced privilege level on either node:
+
...
----
+
If cluster HA has not been disabled, repeat <<step2,Step 2>>.

. [[step8]]Check whether node1 currently holds epsilon:
+
`cluster show`
+
