...
You may also choose to watch the https://www.youtube.com/embed/Ziqg9HL8oYQ?rel=0[_Replace failed drive video_^] that shows an overview of the embedded drive replacement procedure.
