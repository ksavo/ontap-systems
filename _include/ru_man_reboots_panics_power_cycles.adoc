...
. Complete link:relocate_non_root_aggr_node1_node2.html#step1[Step 1] in the section link:relocate_non_root_aggr_node1_node2.html[Relocate non-root aggregates from node1 to node2] again.
. Continue with the node-pair upgrade procedure.
...
. Bring up node2.
. Relocate the remaining aggregates by completing link:link:relocate_non_root_aggr_node2_node3.html#step1[Step 1] through link:link:relocate_non_root_aggr_node2_node3.html#step3[Step 3] in the section link:relocate_non_root_aggr_node2_node3.html[Relocate non-root aggregates from node2 to node3].
. Continue with the node-pair upgrade procedure.
...
. Bring up node3.
. Complete link:link:relocate_non_root_aggr_node2_node3.html#step3[Step 3] again in the section link:relocate_non_root_aggr_node2_node3.html[Relocate non-root aggregates from node2 to node3].
. Continue with the node-pair upgrade procedure.
...
. Bring up node3.
. Relocate the remaining aggregates that belonged to node2 by repeating link:relocate_node2_non_root_aggr_node3_node4.html#Step1[Step 1] through link:relocate_node2_non_root_aggr_node3_node4.html#step3[Step 3] in the section link:relocate_node2_non_root_aggr_node3_node4.html[Relocate node2's non-root aggregates from node3 to node4].
. Continue with the node pair upgrade procedure.
...
. Bring up node4.
. Relocate the remaining aggregates that belonged to node2 by again completing link:relocate_node2_non_root_aggr_node3_node4.html#Step1[Step 1] through link:relocate_node2_non_root_aggr_node3_node4.html#step3[Step 3] in link:relocate_node2_non_root_aggr_node3_node4.html[Relocate node2's non-root aggregates from node3 to node4].
. Continue with the node-pair upgrade procedure.
