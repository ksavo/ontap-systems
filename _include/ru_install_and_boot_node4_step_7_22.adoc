...
a|. Go to section link:set_fc_or_uta_uta2_config_node4.html#configure-fc-ports-on-node4[Set the FC or UTA/UTA2 configuration on node4] and complete the subsections in this section.
