...
You can upgrade the controllers by using the procedure _Upgrading the controller hardware on a pair of nodes running clustered Data ONTAP by moving volumes_ on the NetApp Support Site at link:http://mysupport.netapp.com/[ mysupport.netapp.com].
