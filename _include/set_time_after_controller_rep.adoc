...
. If necessary, set the date in GMT on the _replacement_ node: `set date mm/dd/yyyy`
. If necessary, set the time in GMT on the _replacement_ node: `set time hh:mm:ss`
