...
For detailed information about licensing, refer to link:other_references.html[Other references] to link to the _System Administration Reference_ in the _ONTAP 9 Documentation Center_.
