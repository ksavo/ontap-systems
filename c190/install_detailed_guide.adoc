...
. You can use the animation or the step-by step instructions to complete the cabling between the controllers and to the switches:
+
image::../media/drw_c190_tnsc_unified_network_cabling_animated_gif.gif[]
+
...
. You can use the animation or the step-by step instructions to complete the cabling between the controllers and the switches:
+
image::../media/drw_c190_switched_unified_network_cabling_animated_gif.gif[]
+
[options="header" cols="1,2"]
|===
...
. You can use the animation or the step-by step instructions to complete the cabling between the controllers and to the switches:
+
image::../media/drw_c190_tnsc_ethernet_network_cabling_animated_gif.gif[]
+
[options="header" cols="1,2"]
|===
| Step| Perform on each controller
