...
---
= Move the controller module hardware - AFF A320
:icons: font
:imagesdir: ../media/
...
image::../media/drw_a320_nvbat_move_animated_gif.svg[]
...
image::../media/drw_a320_boot_media_move_animated_gif.svg[]
...
image::../media/drw_a320_dimm_move_animated_gif.svg[]
...
image::../media/drw_a320_pci_riser_move_animated_gif.svg[]
