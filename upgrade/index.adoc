...
|9.8 or later
|xref:upgrade-arl-auto-app/index.html[Using "system controller replace" Commands to Upgrade Controller Hardware Running ONTAP 9.8 or Later]
|9.5 to 9.7
|xref:upgrade-arl-auto/index.html[Using "system controller replace" Commands to Upgrade Controller Hardware Running ONTAP 9.5 to ONTAP 9.7]
|===
...
|9.8 or later
|xref:upgrade-arl-manual-app/index.html[Using Aggregate Relocation to Manually Upgrade Controller Hardware Running ONTAP 9.8 or Later]
|9.0 to 9.7
|xref:upgrade-arl-manual/index.html[Using Aggregate Relocation to Manually Upgrade Controller Hardware Running ONTAP 9.7 or Earlier]
|===
