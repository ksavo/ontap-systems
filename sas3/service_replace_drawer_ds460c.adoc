...
---
= Replacing a drive drawer in a DS460C disk shelf - shelves with IOM12 or IOM12B modules
:icons: font
:imagesdir: ../media/
...
NOTE: DCM2 drive drawers are distinguished by a blue stripe and "DCM2" label on the back.
