...
[.lead]
Replacing a drive drawer in a shelf requires you to move all of the data from the aggregates residing on the disk drives, offline and delete the aggregates, and power off the shelf.
...
[.Lead]
Before you replace a drive drawer you must make sure to update IOM12 FW if needed, move all of the data from the aggregates residing on the disk drives, offline and delete the aggregates, and power off the shelf.

.steps
. Determine if when you replace the failed drive drawer, it will result in the shelf having a combination of IOM12 modules and any number of DCM2 drive drawers.
...
. Move all of the data from the aggregates residing on the disk drives.
+
NOTE: If you attempt this procedure with aggregates on the disk shelf you are removing, you could cause a system disruption with a multidisk panic.
...
* You have moved all of the data from the aggregates residing on the disk drives, offlined and deleted the aggregates to allow the disk drives to become spares, and powered off the shelf.
