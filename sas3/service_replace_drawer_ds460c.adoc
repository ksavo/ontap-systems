...
* The DCM drive drawer and the DCM2 drive drawer can be distinguished by their appearance:
+
The DCM drive drawer looks like the following:
+
image::../media/28_dwg_e2860_de460c_front_no_callouts.gif[]
+
The DCM2 drive drawer is distinguished by a blue stripe and "DCM2" label, and looks like the following:
+
image::../media/drw_dcm2.png[]
+
image::../media/Stoat_L.png[]
+
image::../media/Stoat_M.png[]
+
image::../media/Stoat_XL.png[]
