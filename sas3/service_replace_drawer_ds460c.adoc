...
NOTE: When a DCM or DCM2 drive drawer fails, you receive a DCM or DCM2 drive drawer to replace it.

NOTE: If you replace a failed drive drawer that results in having a combination of IOM12 modules and any number of DCM2 drive drawers, you must upgrade the IOM12 FW to version 0300 or later. The IOM12 FW upgrade can be done before or after replacing a drive drawer. This procedure has you upgrade the FW before... 
