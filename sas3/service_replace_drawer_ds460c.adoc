...
* 5/24. This procedure applies to shelves having DCM drive drawers and/or DCM2 drive drawers. (Drawers can also have two IOM12 or two IOM12B shelf modules.)

NOTE: 5/24 I believe correct. When a DCM or DCM2 drive drawer fails, you receive a DCM or DCM2 drive drawer to replace it.

NOTE: 5/12 Maybe. This procedure addresses like-for-like drive drawer replacements, meaning you can replace a DCM drive drawer with another DCM drive drawer or replace a DCM2 drive drawer with another DCM2 drive drawer. This procedure also addresses drive drawer upgrades, meaning you can replace a DCM drive drawer with a DCM2 drive drawer. And have to update shelf FW...
