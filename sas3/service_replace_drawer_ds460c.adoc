...
* The DCM1 drive drawer and the DCM2 drive drawer can be distinguished by their appearance:
+
The DCM1 drive drawer looks like the following:
+
...
+
image::../media/28_dwg_e2860_de460c_front_no_callouts_dcm2.gif[]
