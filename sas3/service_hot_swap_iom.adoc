...
[.lead]
Your system configuration determines whether you can perform a nondisruptive shelf IOM12/IOM12B hot-swap or a disruptive shelf IOM12/IOM12B replacement when a shelf IOM12/IOM12B fails.
