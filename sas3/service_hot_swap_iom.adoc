...
* The IOM12 moduless and the IOM12B modules can be distinguished by their appearance:
+
The IOM12 modules looks like the following:
+
image::../media/drw_iom12.gif[]
+
The IOM12B modules are distinguished by a blue stripe and "IOM12B" label, and look like the following:
+
