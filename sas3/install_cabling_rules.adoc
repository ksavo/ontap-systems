 ...
 ** Platforms with internal storage, including FAS2600 series, AFF A200, FAS2700 series, AFF A220, and later (with external shelves), can be cabled as single-path HA configurations to support connectivity to an external SAS tape backup device.
 ** Platforms with internal storage, including FAS2600 series, AFF A200, FAS2700 series, AFF A220, and later (with external shelves), do not support quad-path HA connectivity.
