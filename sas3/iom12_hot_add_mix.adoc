...
+
https://docs.netapp.com/us-en/ontap-metrocluster/install-stretch/index.html[Installing and Configuring a Stretch MetroCluster Configruation]
+
...
* You can use this procedure to hot-add disk shelves that were hot-removed within the same MetoCluster system if the affected shelf has mirrored aggregates.
