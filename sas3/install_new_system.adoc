...
=== DS460C drive handing considerations
...
+
For DS460C disk shelves, although the drives are packaged separately, making the shelf lighter, an empty DS460C shelf weighs approximately 132 lb (60kg), exercise the following caution when moving a shelf.
+
...
* If when you installed DS460C shelves as part of your new system installation, you saved the dive packaging materials, use these to repackage the drives before moving them.
+
If you did not save the packing materials, you should place disk drives on cushioned surfaces. Never stack drives on top of each other.
