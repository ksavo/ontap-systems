...
+
If you are moving the DS460C shelf to a different part of the data center or transporting it to a different location, see the section <<Move or transport a DS460C shelf>>.
...
* If when you installed DS460C shelves as part of your new system installation or hot-add, you saved the drive packaging materials, use these to repackage the drives before moving them.
+
