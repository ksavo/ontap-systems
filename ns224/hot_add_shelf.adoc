...
.About this task
* This procedure assumes that your AFF A900 HA pair has at least one existing NS224 shelf and that you are hot-adding up to three additional shelves.
...
Otherwise, go to the next step:
+
 .. Cable shelf NSM A port e0a to controller A slot 2 port a (e2a).
 .. Cable shelf NSM A port e0b to controller B slot 10 port b (e10b).
 .. Cable shelf NSM B port e0a to controller B slot 2 port a (e2a).
 .. Cable shelf NSM B port e0b to controller A slot 10 port b (e10b).

The following illustration shows the second shelf cabling when completed (as well as the first shelf).

image::../media/drw_ns224_a900_2shelves.gif[]
...
image::../media/drw_ns224_a900_3shelves.gif[]
...
image::../media/drw_ns224_a900_4shelves.gif[]
