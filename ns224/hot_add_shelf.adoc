...
+
link:..fas9000/caching_module_and_core_dump_module_replace.html[TEST2 Replace the caching module or add/replace a core dump module]
+
https://docs.netapp.com/platstor/topic/com.netapp.doc.hw-9000-nvmeflashcacherep/GUID-90B4E3EF-FBEF-4A97-9144-42B6400C16AA.html[Replace the caching module or add/replace a core dump module]
...
=== Cable a hot-add shelf for an FAS500f, AFF A250, or ASA A250HA pair

[.lead]
When additional storage is needed, you can hot-add an NS224 drive shelf to an FAS500f, AFF A250, or ASA A250HA pair.
