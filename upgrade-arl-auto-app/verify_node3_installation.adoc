...
For more information on creating and re-creating VLANs, interface groups, and broadcast domains, refer to link:other_references.html[Other references] to link to the _ONTAP 9 Network Management Guide_.
