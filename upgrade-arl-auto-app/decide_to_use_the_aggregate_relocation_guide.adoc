...
+
For upgrading MetroCluster IP configurations, refer to the link:https://docs.netapp.com/ontap-9/index.jsp?topic=%2Fcom.netapp.doc.dot-mcc-mgmt-dr%2Fhome.html[MetroCluster Upgrade, Transition, and Expansion Guide].
...
*For the additional steps needed for A800 systems, go to the step that references A800 in section link:set_fc_or_uta_uta2_config_on_node3.html.html#Step23[Check and configure UTA/UTA2 ports on node3, Step 23], or link:set_fc_or_uta_uta2_config_node4.html#Step23[Check and configure UTA/UTA2 ports on node4, step 23].
