...
+
For upgrading MetroCluster IP configurations, refer to link:other_references.html[References] to link to the _MetroCluster Upgrade, Transition, and Expansion Guide_.
