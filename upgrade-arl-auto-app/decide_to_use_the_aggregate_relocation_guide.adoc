...
**ARL automated upgrade for the AFF A400 platform from an AFF A320 platform is supported from ONTAP 9.9.1.
...
* After you complete a controller upgrade using temporary cluster ports, you can nondisruptively migrate clusters LIFs to  e3a and e3b 100 GbE ports on an AFF A400 platform and e0c and e0d 100 GbE ports on an FAS8300 platform.
