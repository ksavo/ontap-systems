...
. For MetroCluster configuration, V-Series systems and systems with FlexArray Virtualization software connected to storage arrays you must link:setting_the_fc_or_uta_uta2_configuration_on_node4.html[Set the FC or UTA/UT2 configuration on node4] to detect the disks attached to the node.
