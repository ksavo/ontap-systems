...
* For the additional steps needed for A800 systems, go to the step that references A800 in section link:setting_the_fc_or_uta_uta2_configuration_on_node3.html#check-and-configure-uta_uta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3], or link:setting_the_fc_or_uta_uta2_configuration_on_node4.html#check-and-configure-uta_uta2-ports-on-node4[Checking and configuring UTA/UTA2 ports on node4].
