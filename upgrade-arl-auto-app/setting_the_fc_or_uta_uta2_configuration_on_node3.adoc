...
You might need to complete the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#configuring-fc-ports-on-node3[Configure FC ports on node3], the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3], or both sections.

[NOTE]
NetApp marketing materials might use the term UTA2 to refer to CNA adapters and ports. However, the CLI uses the term CNA.

* If node3 does not have onboard FC ports, onboard UTA/UTA2 ports, or a UTA/UTA2 card, and you are upgrading a system with storage disks, you can skip to the section link:arl-auto-app_verifying_the_node3_installation.html[Verify the node 3 installation] section.
* However, if you have a V-Series system or a system with FlexArray Virtualization software with storage arrays, and node3 does not have onboard FC ports, onboard UTA/UTA ports, or a UTA/UTA2 card, return to the section link:arl-auto-app_arl-auto-app_installing_and_booting_node3.html[Install and boot node3] and resume the section at step 23 .

.Choices

* link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#configuring-fc-ports-on-node3[Configure FC ports on node3]
* link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3]
...
You must have the values of the FC port settings from node1 that you saved in the section link:arl-auto-app_preparing_the_nodes_for_upgrade.html[Prepare the nodes for upgrade].

.About this task

You can skip this section if your system does not have FC configurations. If your system has onboard UTA/UTA2 ports or a UTA/UTA2 card, you configure them in link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3].
...
|Has storage disks
a|* If node3 has a UTA/UTA2 card or UTA/UTA2 onboard ports, go to the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3].
* If node3 does not have a UTA/UTA2 card or UTA/UTA2 onboard ports, skip the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3] and go to the section link:arl-auto-app_verifying_the_node3_installation.html[Verify the node3 installation].
|Is a V-Series system or has FlexArray Virtualization Software and is connected to storage arrays
a|* If node3 has a UTA/UTA2 card or UTA/UTA2 onboard ports, go to the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3].
* If node3 does not have a UTA/UTA2 card or UTA/UTA2 onboard ports, skip the section link:arl-auto-app_setting_the_fc_or_uta_uta2_configuration_on_node3.html#checking-and-configuring-utauta2-ports-on-node3[Check and configure UTA/UTA2 ports on node3] and return to link:arl-auto-app_installing_and_booting_node3.html[Install and boot node3] and resume the section at Step 23.
|===
...
|Has storage disks
|Go to link:arl-auto-app_verifying_the_node3_installation.html[Verify the node3 installation].
|Is a V-Series system or has FlexArray Virtualization Software and is connected to storage arrays
|Return to the link:arl-auto-app_stage_3_installing_and_booting_node3_overview.html[Stage 3 Install and boot node3] and resume the section at Step 23
|===
...
. [[step14]]Boot node into boot menu by running `boot_ontap menu`. If you are upgrading to an A800, go to Step 23.
...
. [[step16]]If the system goes into a reboot loop with the message `no disks found`, it indicates that the system has reset the FC or UTA/UTA2 ports back to the target mode and therefore is unable to see any disks. Continue with <<step17,Step 17>> to <<step22,Step 22>> or go to section link:arl-auto-app_verifying_the_node4_installation.html[Verify the node4 installation].
