...
---
= Move the controller module hardware - AFF A220 and FAS2700
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_2600_nvmem_battery_move_animated_gif.svg[]
...
+
image::../media/drw_2600_boot_media_repl_animated_gif.svg[]
...
+
image::../media/drw_2600_dimms.gif[]
...
+
image::../media/drw_2600_fcache.gif[]
