...
+
image::../media/drw_2600_nvmem_battery_move_animated_gif.gif[]
...
+
image::../media/drw_2600_boot_media_repl_animated_gif.gif[]
...
+
image::../media/drw_2600_dimms.svg[]
...
+
image::../media/drw_2600_fcache.svg[]
