...
Go to Cable controllers to drive shelves for drive shelf cabling instructions.
...
To complete setting up your system, go to Complete system setup and configuration.
