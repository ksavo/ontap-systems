...
. Run the default tests on the particular device you added or replaced by entering the following command: `sldiag device run [-dev devtype|mb|slotslotnum] [-name device]`
