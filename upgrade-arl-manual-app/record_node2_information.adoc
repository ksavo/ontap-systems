...
keywords: record, node2, information, cluster, network, FC, ports, NVRAM system ID
summary: Before you can shut down and retire node2, you need to record information about its cluster network, management, and FC ports.
---
